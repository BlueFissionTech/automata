...
| `powershell -File scripts/bf-keryx.ps1 -Action repo-index-issue -RepoPath <repo> -Number <issue> -Title <title> -Progress <summary> -Json` | Retain issue progress and evidence | Updates local retrieval metadata; does not close provider issues |
